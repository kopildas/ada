...
//     console.log(filterData);
  ...
  return (
    <main className="flex h-[calc(100%-160px)] flex-col items-center justify-between px-2 md:px-16 w-full -z-10">
      <div className="w-full">
        <TopNews data={data} />
        <TextMarquee data={data} />
        <div className="hidden md:flex items-center justify-center gap-10 mt-[45rem] md:mt-[8rem] lg:mt-[8rem] mb-[5rem]">
          <BigBox_1 data={data[1]} />
          <BigBox_1 data={data[3]} />
          <BigBox_1 data={data[4]} />
        </div>

        <div className="w-full mt-[6rem] md:mt-0">
          <div className="flex w-full items-center justify-start mt-[7rem] mb-14 -ml-5 bg-red-00">
            <p className="w-auto pl-10 md:pl-0 text-2xl md:text-3xl font-bold text-zinc-800 hover:text-blue-500 transition ease-in-out duration-200">
              The latest
            </p>
      ...
      <div className="w-full flex">
          <div className="w-full md:w-4/5 flex flex-col bg-red-00">
          <div className="flex w-full items-center justify-center md:justify-start mt-[7rem] md:mt-[1rem] mb-14 -ml-5 bg-red-00">
          <Link
          href={`/world`} className="w-auto pl-10 md:pl-0 text-2xl md:text-3xl font-bold text-zinc-800 hover:text-blue-500 transition ease-in-out duration-200">
              World
            </Link>
          ...
          <div className="flex w-full items-center justify-center md:justify-start mt-[7rem] md:mt-[1rem] mb-14 -ml-5 bg-red-00">
          <Link
          href={`/business`} className="w-auto pl-10 md:pl-0 text-2xl md:text-3xl font-bold text-zinc-800 hover:text-blue-500 transition ease-in-out duration-200">
              Business
            </Link>
