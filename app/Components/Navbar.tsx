  ...
  return (
    <nav className="w-full h-40 flex bg-gradient-to-r from-slate-800 to-violet-900 px-10">
      <div className="w-auto bg-green-00 h-full flex items-center justify-center gap-">
        <div className="w-60 h-full bg-rd-300 flex items-center justify-center">
          <Image src={logo} alt="ada logo" />
        </div>
        <div className="h-full bg-red-40 flex items-center justify-center px-5 w-auto">
        ...
        <div className="w-40 h-full bg-ed-200 flex items-center justify-center space-x-3">
          <Link href="">
      ...
      <div className="w-full bg-red-90 h-full">
