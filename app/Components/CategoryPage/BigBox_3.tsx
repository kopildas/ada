...
const BigBox_3 = ({ data }: { data: news }) => {
  ...
  return (
    <Link
    href={`/${data.category}/${data._id}`} className="w-1/3 flex flex-col group">
      ...
      {truncatedTitle2 && <p className="md:block hidden lg:text-xl text-base md:text-lg font-bold  mb-2 text-gray-800 group-hover:text-blue-500 duration-500 transition ease-in-out">{truncatedTitle2}</p>}       
