...
// console.log(truncatedTitle)
  return (
    <Link  href={`/${data.category}/${data._id}`} className='flex flex-col w-[40%] lg:mb-10 bg-blue-00 lg:items-center lg:justify-center h-fit group'>
        ...
        <div className='md:w-[140px] lg:w-[270px] w-[150px] flex flex-col items-start md:justify-center -ml-10 md:ml-0 md:mr-0 bg-red-00 text-zinc-900 group-hover:text-blue-500 duration-500 transition ease-in-out'>
              ...
              <p className="lg:text-xl text-xs md:mb-4 lg:mb-4 text-zinc-500 group-hover:text-blue-500">{data.author}</p>
        </div>
    </Link>
  )
}
