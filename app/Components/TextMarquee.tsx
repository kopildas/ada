...
const TextMarquee = ({ data }: { data: news[] }) => {
  // console.log(data);
  return (
    <div className="relative flex text-slate-200 overflow-x-hidden bg-gradient-to-r from-slate-800 to-violet-900 rounded-[3.5rem] md:mt-[55rem] lg:mt-[15rem] bg-green-300">
