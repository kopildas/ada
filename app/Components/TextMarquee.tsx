...
const TextMarquee = ({ data }: { data: news[] }) => {
  // console.log(data);
  return (
    <div className="relative flex text-slate-200 overflow-x-hidden bg-gradient-to-r from-slate-800 to-violet-900 rounded-[3.5rem] mt-[58rem] md:-mt-[10rem] lg:mt-[10rem] bg-green-300">
